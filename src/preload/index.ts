...
const api = {
  ...
  importMistralWebSession: () => ipcRenderer.invoke('mistral-web-session:import'),
  getMistralWebSessionStatus: () => ipcRenderer.invoke('mistral-web-session:get-status'),
  clearMistralWebSession: () => ipcRenderer.invoke('mistral-web-session:clear'),
  ...
  setOllamaWebSession: (cookie: string) => ipcRenderer.invoke('set-ollama-web-session', cookie),
  clearOllamaWebSession: () => ipcRenderer.invoke('clear-ollama-web-session'),
