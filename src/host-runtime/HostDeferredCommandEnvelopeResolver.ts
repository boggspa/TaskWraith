...
/** Narrow injected execution port; desktop adapts HostBridgeCommandExecutor structurally. */
export interface HostDeferredCommandEnvelopeResolverExecutor {
  execute(
    command: HostCommand,
    context: { readonly actor: HostActorIdentity }
  ): HostCommandExecutionResult | Promise<HostCommandExecutionResult>
}

export type HostDeferredCommandEnvelopeResolverResult =
  | { kind: 'executed'; command: HostCommand; result: HostCommandExecutionResult }
...
export interface HostDeferredCommandEnvelopeResolverOptions {
  ...
  executor: HostDeferredCommandEnvelopeResolverExecutor
}
...
export class HostDeferredCommandEnvelopeResolver {
  ...
  private readonly executor: HostDeferredCommandEnvelopeResolverExecutor
