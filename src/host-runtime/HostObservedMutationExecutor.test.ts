...
const SUCCESS_EXECUTION: HostCommandExecutionResult = {
  status: 'succeeded',
  resultSummary: 'ok'
}

const FAILED_EXECUTION: HostCommandExecutionResult = {
  status: 'failed',
  errorCode: 'bridge_not_executed',
  errorMessage: 'nope'
}

const CANCELLED_EXECUTION: HostCommandExecutionResult = {
  status: 'cancelled',
