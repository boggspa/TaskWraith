...
import type { HostTransportVerifiedClientContext } from '../host-shared/HostCommandIdentity'
import {
  HostSession,
...
describe('HostSession structural isolation', () => {
  it('does not import listeners, net/http, Electron, Authority, bootstrap, or composition roots', () => {
