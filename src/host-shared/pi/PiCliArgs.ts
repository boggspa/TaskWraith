/**
 * MOVED from src/main/pi/PiCliArgs.ts (165 lines) — this is now the single
 * definition, shared by the pure-Node Host and Electron main.
 *
 * src/main/pi/PiCliArgs.ts is a re-export shim, so its public API is byte-identical
...
import { isPiTaskWraithToolName, type PiTaskWraithToolName } from './PiTaskWraithToolNames'
