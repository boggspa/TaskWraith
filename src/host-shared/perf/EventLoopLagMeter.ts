/**
 * Event-loop lag meter (perf-epic T1 instrumentation; host-shared since
 * Independent Threads M1 so the Host runtime can meter its own loop —
 * src/main/perf/EventLoopLagMeter re-exports this module for main importers).
 *
