...
export const PI_STATIC_MODELS: readonly PiModelDefinition[] = [
  ...
  { wireId: 'openrouter/nvidia/nemotron-3-ultra-550b-a55b:free', upstream: 'openrouter', modelId: 'nvidia/nemotron-3-ultra-550b-a55b:free', label: 'Nemotron 3 Ultra', contextWindow: 1_000_000, maxOutputTokens: 65_536, thinking: false, images: false }
]
