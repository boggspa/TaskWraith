...
export type HostObservedMutationExecuteCommand = (
  command: HostCommand
) => HostBridgeCommandExecutorResult | Promise<HostBridgeCommandExecutorResult>
...
export type HostObservedMutationResult =
  ...
  | {
      ...
      readonly execution: HostBridgeCommandExecutorResult
...
export class HostObservedMutationExecutor {
  ...
  async execute(command: HostCommand): Promise<HostObservedMutationResult> {
    ...
    let execution: HostBridgeCommandExecutorResult | undefined
    let thrown = false
    try {
    ...
    const returned = execution as HostBridgeCommandExecutorResult
