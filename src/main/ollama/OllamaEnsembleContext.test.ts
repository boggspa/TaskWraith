...
describe('OllamaEnsembleContext', () => {
  it('uses the shared Ollama context windows instead of tiny provider-level fallbacks', () => {
    ...
    expect(resolveOllamaContextTokenLimit('qwen3.8-flash-next:125b-mlx')).toBe(262_144)
    expect(resolveOllamaContextTokenLimit('mistral-medium-3.5:128b')).toBe(262_144)
