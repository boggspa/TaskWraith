      ...
      inputSchema: {
        ...
        properties: {
          ...
          mode: {
            ...
            description:
              'Default read_only sets inspection/review task intent while preserving each target seat’s configured permission tier. locked_writers is feature-gated and allows writer-intent targets only when write-locking is enabled.'
          },
          targetStage: {
            type: 'string',
