...
export const IPC_ARGUMENT_SCHEMAS: Record<string, ArgSpec[]> = {
  ...
  // Project Studio drafts + reference extract (payload validated in domain handlers).
  'projects:studio-generate': ['object'],
  ...
  'channels:member:begin-join': ['object'],
  'channels:member:confirm-join': [],
  'channels:member:reconnect': ['object'],
  'channels:member:append': ['object'],
  'channels:member:resume': [],
  'channels:member:disconnect': [],
  'channels:member:reset-local-history': ['object'],
  'channels:member:forget': ['object'],
  ...
  'get-main-perf-snapshot': ['optionalObject'],
  ...
  'record-renderer-error-boundary': ['object'],
  ...
  // Skills Settings — payload objects validated in skillsHandlers (scope + paths).
  'skills:list-effective': ['object'],
  'skills:list-user': [],
  'skills:list-workspace': ['object'],
  'skills:upsert': ['object'],
  ...
  'hooks:get-user': [],
  'hooks:get-workspace': ['workspacePath'],
  'hooks:upsert': ['object'],
  'hooks:delete': ['object'],
  ...
  'copy-chat-markdown-transcript': ['chatId', 'optionalObject'],
  'download-chat-markdown-transcript': ['chatId', 'optionalObject'],
  'copy-chat-messages': ['chatId', 'optionalObject'],
  ...
  'licenses:get-status': [],
  'licenses:open-notice': ['nonEmptyString'],
