...
describe('resolveContextWindow', () => {
  ...
  it('resolves representative model ids across providers', () => {
    ...
    expect(resolveContextWindow('cursor', 'grok-4.6')).toBe(256_000)
    expect(resolveContextWindow('cursor', 'cursor-grok-4.6-high')).toBe(256_000)
    expect(resolveContextWindow('cursor', 'cursor-grok-4.6-xhigh-fast')).toBe(256_000)
    ...
    expect(resolveContextWindow('ollama', 'lfm2.5-thinking:1.2b')).toBe(128_000)
    expect(resolveContextWindow('ollama', 'granite4:3b')).toBe(131_072)
    expect(resolveContextWindow('ollama', 'nemotron-3-nano:4b')).toBe(262_144)
