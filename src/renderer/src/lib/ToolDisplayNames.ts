...
export const TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  list_active_runs: 'Listed active runs',
  cancel_active_run: 'Cancelled active run',
  ...
  blackboard_post: 'Posted blackboard entry',
  blackboard_read: 'Read blackboard',
  blackboard_delete: 'Cleaned blackboard',
  summary: 'Summary',
  intent: 'Intent',
  progress: 'Progress',
