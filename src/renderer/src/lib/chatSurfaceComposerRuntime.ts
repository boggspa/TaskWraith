...
export function buildDetachedChatSurfaceBase<T extends Record<string, unknown>>(focused: T): T {
  return {
    ...focused,
    activeEnsembleConcurrentMode: false,
    activeEnsembleFanoutPolicy: 'off',
    activeEnsembleOrchestrationMode: 'turn_bound',
    ...
    updateCurrentEnsembleConcurrentMode: NOOP_DETACHED_SURFACE_ACTION,
    ...
    updateCurrentEnsembleContextChars: NOOP_DETACHED_SURFACE_ACTION,
    updateCurrentEnsembleMaxContinuationHops: NOOP_DETACHED_SURFACE_ACTION,
    updateCurrentEnsembleOrchestrationMode: NOOP_DETACHED_SURFACE_ACTION,
