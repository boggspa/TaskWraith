...
describe('RightDockHome', () => {
  ...
  it('renders a navigation landmark with all cards and contextual disabled states', () => {
    ...
    expect(html.match(/class="pill-card right-dock-home-card/g)).toHaveLength(14)
    expect(html.match(/class="pill-card-inner right-dock-home-card-inner"/g)).toHaveLength(14)
