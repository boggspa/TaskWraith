 ...
 *
 * Multiview splits ONLY the central chat pane into 1-8 panes. It is distinct
...
export interface MultiviewLayoutSpec {
  ...
  label: string
  /** Number of panes this layout renders (1-8). */
  paneCount: number
...
export const MAX_MULTIVIEW_PANES = 8
