...
npmStep('identity-handoff', 'verify:identity-handoff')
npmStep('security:deps')
npmStep('lint:errors')
npmStep('guard:platform-path-literals')
npmStep('typecheck')
npmStep('guard:architecture')
npmStep('guard:renderer-bundle')
npmStep('guard:provider-intent')
npmStep('guard:doctrine-integrity')
npmStep('guard:third-party-notices')
npmStep('guard:ios-plist')
npmStep('guard:platform-portability')
npmStep('guard:platform-evidence')
npmStep('guard:control-bytes')
