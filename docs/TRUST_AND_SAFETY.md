...
| Shell and git                      | Approval-gated (destructive host commands fail unconditionally) the selected provider mode grants more authority.                           | Commands run in the workspace context; git status/diff/commit surfaces.                                                                                                                                                                                           | Command output can be sent to the provider and stored in local history.                                                                                                                          | Command approvals, auto-denies, and run events are auditable.                                                                                                                                                                                                                                                                                                             |
