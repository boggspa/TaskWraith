...
3. Click **Approve & implement** to accept the plan as-is — this switches the chat off plan mode to **Accept Edits** and re-dispatches the thread with write access to implement it.
