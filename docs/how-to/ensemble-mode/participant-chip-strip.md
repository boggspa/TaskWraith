...
4. Use the **+** button at the end of the strip to add a participant (pick a provider from the popover), or select a chip and use the **−** button to remove it. Ensembles require at least 2 participants, and the strip caps out at 18.
