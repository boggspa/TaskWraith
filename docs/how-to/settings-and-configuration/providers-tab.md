...
1. Open **Settings → AI & Providers → Providers** to see the provider
   ...
   static-live Codex, Claude, Kimi, Cursor, Grok, Ollama, and Pi providers.
