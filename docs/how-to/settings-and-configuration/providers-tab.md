...
1. Open **Settings → AI & Providers → Providers** to see the provider
   ...
   static-live Codex, Claude, Kimi, Cursor, Grok, Ollama, Pi, Mistral, and Muse
   providers.
