...
4. To branch off without losing context, open a side chat from the message context menu or let an agent delegate work to a sub-thread — both nest under their parent chat, one level deep.
