...
<!-- TODO(screenshot): Composer slash command menu open with available commands -->
...
## Tips & related
- [Plus Tools Menu](plus-tools-menu.md) — the same menu also exposes Slash commands plus attachments, screen watch, and other composer tools.
