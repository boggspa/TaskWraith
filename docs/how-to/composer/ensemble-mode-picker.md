...
5. Use the **Off / Read / Writer** buttons beside the picker to enable parallel fan-out for read-only (or, where unlocked, writer) participants.
...
- [Fan-Out Toggle](../ensemble-mode/fan-out.md) — more on the Off/Read/Writer chip beside this picker.
