...
- Track all twelve stable provider identities. The ten static-live providers
  are Codex, Claude, Kimi, Cursor, Grok, Ollama, Pi, Mistral, Muse, and Devin;
...
Cognition's brand page lists Devin lockups, but its download links return 404
(checked 2026-09-01). The Devin mark is therefore the transparent 256 px
favicon that Cognition's own Devin documentation site serves, byte-identical
for its light and dark colour schemes: black three-hexagon mark on a
transparent canvas. The on-dark file is the same recorded RGB-inversion
treatment as Ollama's, so the mark reads white without touching its alpha.
...
- `png/*.png` — first-party PNG bytes plus explicitly labelled Pi, Ollama, and
  Devin derivatives and the DeepSeek SVG rasterisation.
...
| `devin`                 | Transparent three-hexagon mark + recorded RGB-inverted dark derivative | [Devin documentation favicon](https://docs.devin.ai/mintlify-assets/_mintlify/favicons/cognitionai/Ycul7J1XWDV1FX48/_generated/favicon/android-chrome-256x256.png) (first-party; the [brand page](https://cognition.com/brand) lockup downloads return 404) |
...
The Devin favicon and its recorded dark derivative were added on **2026-09-01**.
