...
struct ContextWindowsTests {
    ...
    func modelIdWins() {
        ...
        #expect(
            ContextWindows.resolve(provider: "ollama", model: "devstral-small-2:24b") == 131_072)
        #expect(ContextWindows.resolve(provider: "ollama", model: "ministral-3:14b") == 131_072)
        #expect(ContextWindows.resolve(provider: "ollama", model: "lfm2.5:8b") == 131_072)
