...
/// Collapsed per-lane fan-out result viewport — LiveActivityViewport labels and
/// behaviour from Electron's `EnsembleFanoutResultCard`. Header + card chrome
/// stay outside the scroll.
///
