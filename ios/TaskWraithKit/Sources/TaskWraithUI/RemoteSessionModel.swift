    ...
    public func enterDemoMode() {
        ...
        {"schemaVersion":1,"generatedAt":"2026-06-19T10:45:00Z",
         "notifications":[
          ...
          {"id":"claude-fable-mythos-return-2026-07-01","kind":"addition","title":"Claude Fable 5 access is returning.","body":"Fable 5 is currently available in TaskWraith until July 7, 2026. After that it becomes SDK/API-only for a short while before broader access returns. It still brings 1M context, 128K max output, adaptive thinking, a Fast tier, and $10/$50 per MTok pricing.","tone":"default","accent":"claude","dismissible":true},
