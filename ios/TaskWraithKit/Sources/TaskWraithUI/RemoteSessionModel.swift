...
public final class RemoteSessionModel: ObservableObject {
    ...
    public func enterDemoMode() {
        ...
        {"schemaVersion":1,"generatedAt":"2026-06-19T10:45:00Z",
         "notifications":[
          {"id":"new-additions-2026-07-09","kind":"addition","title":"New Additions","body":"Claude Sonnet 5 and Fable 5, the GPT-5.6 Luna/Terra/Sol trio, Cursor Grok 4.5, Grok 4.5 Fast, and two new local Ollama models are all available now.","tone":"default","accent":"default","dismissible":true,"groups":[{"provider":"claude","label":"Claude","models":[{"name":"Sonnet 5","blurb":"Anthropic's fast coding model — adaptive thinking, 1M context, 85.2% SWE-bench Verified."},{"name":"Fable 5","blurb":"Anthropic's frontier tier above Opus — 1M context, 128K max output, adaptive thinking, and a Fast tier."}]},{"provider":"codex","label":"Codex","models":[{"name":"GPT-5.6-Luna","blurb":"Fast and affordable agentic coding — with the Max reasoning tier."},{"name":"GPT-5.6-Terra","blurb":"Balanced agentic coding for everyday work — Max and Ultra reasoning tiers."},{"name":"GPT-5.6-Sol","blurb":"Latest frontier agentic coding model — Max and Ultra reasoning tiers."}]},{"provider":"cursor","label":"Cursor","models":[{"name":"Cursor Grok 4.5","blurb":"Cursor's first-party model pool — 500K context, Low/Medium/High reasoning, and a Fast toggle."}]},{"provider":"grok","label":"Grok","models":[{"name":"Grok 4.5 Fast","blurb":"xAI's 500K-context coding model behind Grok Build, with Low/Medium/High reasoning."}]},{"provider":"ollama","label":"Ollama","models":[{"name":"Deep Reinforce - Ornith 9B + Ornith 35B","blurb":"Open-source 262K-context coding models — local inference, no per-token cost."},{"name":"Liquid - LFM 2.5 8B-1A","blurb":"A 131K-context local tool/thinking model for agentic coding — no cloud account required."}]}]}
         ],
