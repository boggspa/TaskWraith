...
| Channel members                    | Host-created Channel invite per shared chat.                                                      | Least-privilege projection of one shared chat; member messages enter the host's review queue.                                                                                                                                                                     | Projection/message frames travel over the channel transport, encrypted end to end.                                                                                                               | Host remains authority for transcript writes; member messages post only after host approval and stay external/untrusted rows.                                                                                                                                                                                                                                             |
