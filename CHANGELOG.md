...
- **`skill_list` / `skill_read` MCP.** Progressive skill discovery: seats see a compact prompt catalog, then pull metadata or full bodies via read-only MCP tools (gateway v14 / auto-allowed reads).
